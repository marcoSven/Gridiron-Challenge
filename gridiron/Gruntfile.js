module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            dist: {
                files: { 'assets/js/gridiron.min.js': 'assets/js/gridiron.js' },
        ...
        sass: {
            dist: {
                ...
                files: { 'assets/css/gridiron.css': 'assets/css/sass/styles.scss' }
            }
        },
        cssmin: { dist: { files: { 'assets/css/gridiron.min.css': 'assets/css/gridiron.css' } } },
        usebanner: {
            taskName: {
                options: {
                    position: 'top',
                ...
                files: { src: ['assets/css/gridiron.min.css'] }
            }
        }
    });
